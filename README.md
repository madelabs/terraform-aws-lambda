...
| <a name="input_function_runtime"></a> [function\_runtime](#input\_function\_runtime) | An object selecting the Lambda runtime and its associated placeholder.  Must be: (dotnet6\|dotnet8\|nodejs18.x\|python3.x) | `string` | n/a | yes |
